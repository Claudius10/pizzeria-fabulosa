package org.clau.fabulosa.securityserver.exception;
...
import org.clau.fabulosa.securityserver.service.ErrorService;
...
public class MyExceptionHandler extends ResponseEntityExceptionHandler {
   ...
   private ResponseDTO handleAuthenticationException(AuthenticationException ex, WebRequest request) {
	  ...
	  if (logged) {
		 error = errorService.create(cause, message, MyApps.SECURITY_SERVER, path, fatal);
	  } else {
